...
namespace VideoLibDAL
{
    ...
    partial void InsertOrderUser(OrderUser instance);
    partial void UpdateOrderUser(OrderUser instance);
    partial void DeleteOrderUser(OrderUser instance);
    ...
    partial void DeleteOrder(Order instance);
		...
		public System.Data.Linq.Table<OrderUser> OrderUsers
		{
			get
			{
				return this.GetTable<OrderUser>();
			}
		}
    ...
    partial void OnposterpathChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Movie_Order", Storage="_Orders", ThisKey="id", OtherKey="idMovie")]
	...
	public partial class User : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<OrderUser> _OrderUsers;
    ...
    partial void OnsexChanged();
		...
		public User()
		{
			this._OrderUsers = new EntitySet<OrderUser>(new Action<OrderUser>(this.attach_OrderUsers), new Action<OrderUser>(this.detach_OrderUsers));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_OrderUser", Storage="_OrderUsers", ThisKey="Id", OtherKey="idUser")]
		public EntitySet<OrderUser> OrderUsers
		{
			get
			{
				return this._OrderUsers;
			}
			set
			{
				this._OrderUsers.Assign(value);
			}
		}
		...
		private void attach_OrderUsers(OrderUser entity)
		{
			this.SendPropertyChanging();
			entity.User = this;
		}
		
		private void detach_OrderUsers(OrderUser entity)
		{
			this.SendPropertyChanging();
			entity.User = null;
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.OrderUser")]
	public partial class OrderUser : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnidOrderChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_OrderUser", Storage="_User", ThisKey="idUser", OtherKey="Id", IsForeignKey=true)]
		public User User
		{
			get
			{
			...
			set
			{
							...
							|| (this._User.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.OrderUsers.Remove(this);
					}
					this._User.Entity = value;
					if ((value != null))
					{
						value.OrderUsers.Add(this);
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Order_OrderUser", Storage="_Order", ThisKey="idOrder", OtherKey="Id", IsForeignKey=true)]
		public Order Order
		{
			get
			{
    ...
    partial void OnidMovieChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Order_OrderUser", Storage="_OrderUsers", ThisKey="Id", OtherKey="idOrder")]
		public EntitySet<OrderUser> OrderUsers
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Movie_Order", Storage="_Movie", ThisKey="idMovie", OtherKey="id", IsForeignKey=true)]
		public Movie Movie
		{
			get
			{
